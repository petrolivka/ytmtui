...
class Ytmtui < Formula
  ...
  homepage "https://github.com/OWNER/ytmtui"
  url "https://github.com/OWNER/ytmtui/archive/refs/tags/v0.1.0.tar.gz"
  sha256 "REPLACE_ON_RELEASE"
  license "GPL-3.0-or-later"
  head "https://github.com/OWNER/ytmtui.git", branch: "master"
